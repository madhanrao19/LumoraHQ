...
Version: 1.2 foundation draft. One ADR is accepted, six are proposed and awaiting review; the backlog below tracks decisions the other architecture books have already flagged as open.

## Process

1. Copy the [ADR template](../24-templates/adr-template.md).
2. Number it sequentially (next is `ADR-0008`).
