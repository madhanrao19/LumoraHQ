...
| [`lumora-design-system/`](lumora-design-system/) | ✅ Populated (tokens only) | Color tokens shared across `lumora-academy` and `lumora-mobile` (ADR-0013). No shared component library — that needs an undecided cross-platform framework choice; see the package's own README. |
